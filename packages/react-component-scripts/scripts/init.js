...
module.exports = function(appPath, componentName, verbose, originalDirectory, template) {
  var ownPackageName = require(path.join(__dirname, '..', 'package.json')).name;
  var ownPath = path.join(appPath, 'node_modules', ownPackageName);
  var appPackage = require(path.join(appPath, 'package.json'));
  var useYarn = fs.existsSync(path.join(appPath, 'yarn.lock'));
  var properComponentName = pascalcase(componentName);
  ...
  appPackage.scripts = {
    ...
    'test': 'react-component-scripts test --env=jsdom',
    'eject': 'react-component-scripts eject',
    'prepublish': 'react-component-scripts prepublish',
  };

  appPackage.main = 'build/' + properComponentName;
  ...
  proc.on('close', function (code) {
    ...
    if (originalDirectory &&
        path.join(originalDirectory, componentName) === appPath) {
      cdpath = componentName;
    } else {
      cdpath = appPath;
    }

    console.log();
    console.log('Success! Created ' + componentName + ' at ' + appPath);
    console.log('Inside that directory, you can run several commands:');
    console.log();
    console.log(chalk.cyan('  ' + command + ' start'));
    console.log('    Starts the development server.');
    console.log();
    console.log(chalk.cyan('  ' + command + ' publish'));
    console.log('    Bundles and distributes your component onto npm.');
    console.log();
    ...
    console.log('    and scripts into the component directory. If you do this, you can’t go back!');
    console.log();
